import {GET_ALL_GAMES,GET_GENRES, GET_PLATFORMS, SET_GAMES, FILTER_GAMES, ORDER_TYPE, ORDER_ASCEND, SEARCH, CLEAR} from "./actiontypes";
...
export const orderType = (value, type) => {
    return{
        type: ORDER_TYPE,
        payload: {value, type}
    }
